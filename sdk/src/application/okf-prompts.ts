export interface OkfPromptAsset {
  readonly id: "okf-metadata-enrichment" | "okf-web-source-augmentation";
  readonly purpose: "metadata-enrichment" | "web-source-augmentation";
...
const SOURCE_ATTRIBUTION =
  "Adapted from Google knowledge-catalog/okf reference_agent prompt sources (reference_instruction.md and web_ingestion_instruction.md); review upstream Apache-2.0 license obligations before reusing substantial wording.";
...
] as const satisfies readonly OkfPromptAsset[];
